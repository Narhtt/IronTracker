...
- **Heatmap de Régularité Annuelle (52 Semaines)** :
  - Intégration d'une matrice calendaire dynamique de 52 semaines (364 jours glissants) dans l'onglet Analytics, inspirée du modèle d'activité GitHub.
  - Bascule interactive entre le mode **Séries validées** et **Volume total accumulé**.
  - Filtrage multi-groupes musculaires avec recoloration thématique automatique de la matrice (Pectoraux, Dos, Quadriceps, Ischios, Fessiers, Épaules, Bras, Abdos).
  - Calcul en temps réel des statistiques de régularité : série consécutive en cours (*streak*) et record annuel de régularité.
  - Infobulle interactive détaillée avec liste des séances, séries et volumes réalisés par jour.
...
- **Partage Social & Export de Séance Multi-Formats (Point 11)** :
  ...
  - Styles autonomes avec palette CSS directe pour un rendu fidèle et net sur tout appareil et système d'exploitation.
